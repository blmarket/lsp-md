...
pub struct Backend {
    pub client: Client,
    pub ast_map: DashMap<String, HashMap<String, Func>>,
    pub document_map: DashMap<String, Rope>,
    pub semantic_token_map: DashMap<String, Vec<ImCompleteSemanticToken>>,
}
        ...
        let inlay_hint_list = hashmap
            ...
            .map(|(k, v)| {
                (
                    ...
                    k.end,
                    match v {
                        crate::chumsky::Value::Null => "null".to_string(),
                        crate::chumsky::Value::Bool(_) => "bool".to_string(),
                        crate::chumsky::Value::Num(_) => "number".to_string(),
                        crate::chumsky::Value::Str(_) => "string".to_string(),
                        crate::chumsky::Value::List(_) => "[]".to_string(),
                        crate::chumsky::Value::Func(_) => v.to_string(),
                    },
                )
            })
            .filter_map(|item| {
